...
public class View {
    ...
    private void initUI() {
        ...
        threeMusketeersLabel.setFont(Font.font("Arial Unicode MS", 30));
        threeMusketeersLabel.setStyle("-fx-text-fill: #e8e6e3;");

        gameModeLabel.setText("");
        gameModeLabel.setFont(Font.font("Arial Unicode MS", 20));
        gameModeLabel.setStyle("-fx-text-fill: #e8e6e3");

        messageLabel.setFont(Font.font("Arial Unicode MS", 20));
    ...
    private void showBoard() {
        ...
        undoButton.setFont(Font.font("Arial Unicode MS", 12));
        ...
        saveButton.setFont(Font.font("Arial Unicode MS", 12));
        ...
        restartButton.setFont(Font.font("Arial Unicode MS", 12));
	...
	setMessageLabel(String.format("[%s turn] Move Done", model.getBoard().getTurn().getType()));
	...
	saveFileNameTextField.setText(saveFileNameTextField.getText());

	String directory = "Boards/";
	File file = new File(directory + saveFileNameTextField.getText());

	if (file.getName().endsWith(".txt") && !file.exists()) {
